# Orbit Wars: Heuristic Simulation Agent 🚀

這是我在 HW1 作業中選擇介紹的技術專案。本專案探討了如何在模擬環境中，利用啟發式演算法（Heuristic Algorithm）來建立自動化代理人（Agent）。

## 💡 專案簡介
Orbit Wars 是一個基於空間與軌道物理的模擬環境。開發者透過設計啟發式規則，讓 AI 代理人能夠在複雜的遊戲環境中自動做出決策。

## 🔍 核心技術亮點
* **環境模擬 (Simulation)**：建構複雜的物理與規則環境。
